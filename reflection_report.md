...
I started with 4 agents: an orchestrator, an inventory agent, a quoting agent and a sales agent. This worked relatively well right from the start, though there were a few details to address. 
